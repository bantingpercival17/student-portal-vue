                ...
                <div class="d-inline-block w-100">
                    ...
                    <div class="row mt-2">
                        <div class="col-md">
                            ...
                            <p class="text-info h5 fw-bolder">
                                {{ propsEnrollment.enrollment_assessment.course.course_name }}
                            </p>
                        </div>
                        <div class="col-md">
                            ...
                            <p class="text-info h5 fw-bolder">
                                {{
                                    this.propsEnrollment.enrollment_assessment.year_level === '11' ? 'GRADE 11' :
                                    this.propsEnrollment.enrollment_assessment.year_level === '12' ? 'GRADE 12' :
                                        this.propsEnrollment.enrollment_assessment.year_level === '1' ? '1st Class' :
                                            this.propsEnrollment.enrollment_assessment.year_level === '2' ? '2nd Class' :
                                                this.propsEnrollment.enrollment_assessment.year_level === '3' ? '3rd Class' :
                                                    this.propsEnrollment.enrollment_assessment.year_level === '4' ? '4th Class' : ''
                                }}
                            </p>
                        </div>
                    </div>
...
export default {
    ...
    data() {
        return {
            viewName: 'STEP 2: ENROLLMENT ASSESSMENT'
        }
    },
    props: { propsEnrollment: Object }
}
</script>