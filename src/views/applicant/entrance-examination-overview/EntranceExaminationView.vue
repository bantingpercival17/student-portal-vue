                    ...
                    <div class="">
                        ...
                        <div class="question-choices row">
                            <div class="col-lg-6 col-md-12"
                                v-for="(item, index) in questionList[currentQuestion].question.choices_v2" :key="index">
...
export default {
    ...
    data() {
        return {
            ...
            questionNumber: [],
            currentQuestion: 0,
            duration: 60 * 60 * 2000, // 1 hour in milliseconds
            timerInterval: null,
            startTime: null,
            answerActive: [],
            selectedChoices: []
    ...
    mounted() {
        const link = 'applicant/examination'
        axios.get(link, {
            headers: {
