<template>
    <div class=" row align-items-center">
                ...
                <form @submit.prevent="onLogin" class="row g-3">
                    ...
                    <div class="">
                        ...
                        <div class="col-lg-12 d-flex justify-content-between">
                            ...
                            <router-link :to="{ name: 'app-layout.applicant-forget-password' }" class="">Forgot
        ...
        <div class="res-hide col-lg-7 d-md-block d-none p-0">
            <img src="@/assets/resources/banner/banner-login-1.jpg" class="img-fluid gradient-main vh-100" alt="images">
        </div>
    </div>
</template>
<script>
