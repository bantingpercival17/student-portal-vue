<template>
    <div class="" v-if="propsSemester.semester == 'First Semester'">
        <div v-if="propsEnrollment.medical_result">
            <div v-if="propsEnrollment.medical_result.is_fit == 1">
                ...
                <div v-else>
                    ...
                    <div class="d-inline-block w-100">
                        <p class="mb-3">
                            Start of Enrollment for School Year
            ...
            <div v-else>
                <div class="timeline-dots timeline-dot1 border-secondary text-secondary"></div>
...
<script>
export default {
    name: 'RegistartionView',
    data() {
        return {
            viewName: 'STEP1 : ENROLLMENT REGISTRATION'
        }
    },
    props: { propsEnrollment: Object, propsSemester: Object }
}
</script>