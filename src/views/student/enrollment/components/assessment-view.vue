<template>
    <div class="" v-if="propsData.registration">
                ...
                <div class="row mt-2">
                    <div class="col-md">
                        ...
                        <p class="text-info h5 fw-bolder">
                            {{ propsData.enrollment_assessment.course.course_name }}
                        </p>
                    </div>
                    <div class="col-md">
                        ...
                        <p class="text-info h5 fw-bolder">
                            {{
                                this.propsData.enrollment_assessment.year_level === '11' ? 'GRADE 11' :
                                    this.propsData.enrollment_assessment.year_level === 12 ? 'GRADE 12' :
                                        this.propsData.enrollment_assessment.year_level === 1 ? '1st Class' :
                                            this.propsData.enrollment_assessment.year_level === 2 ? '2nd Class' :
                                                this.propsData.enrollment_assessment.year_level === 3 ? '3rd Class' :
                                                    this.propsData.enrollment_assessment.year_level === 4 ? '4th Class' : ''
                            }}
                        </p>
                    </div>
                </div>
